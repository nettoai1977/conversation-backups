...
- **Reverse Prompting**: At the end of every major task and during 30-minute Heartbeat, ask: (1) What is the most logical next step I can take right now without help? (2) What specific piece of information/access am I missing that prevents me from being 10x more effective? (3) If I were an elite Chief of Staff, what would I tell you to focus on today to ensure we hit our long-term targets?